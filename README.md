...
- Una conversación nueva debe comenzar con `ATLAS` tras cuatrocientos milisegundos de silencio. Después hay diez segundos de continuación natural sin repetir la wake word. Hablar durante la respuesta aplica barge-in nativo sin volver a decir `ATLAS`. En el A1, una ruta WebRTC AEC de PulseAudio resta el altavoz HDMI del micrófono USB para reproducir el comportamiento acústico integrado de un portátil.
