...
WebScreen and normal `atlas-chat` sessions; it does not touch the knowledge in
`.atlas/context/knowledge`, `MEMORY.md`, `NOTES.md`, ADB records or the Markdown that gives you
