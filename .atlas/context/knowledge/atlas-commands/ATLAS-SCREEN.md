...
`off` stops all four physical surfaces, blanks the framebuffer, and forces HDMI-A-1 into DRM Off. It does not stop the ATLAS Native Broker, WebScreen's server, or the separate virtual desktop.
...
sandbox and private profile, and leaves X11, Native Broker, Bluetooth, audio and the
