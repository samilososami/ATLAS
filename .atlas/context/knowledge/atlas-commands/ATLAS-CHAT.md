...
`@AGENTS.md` y `@atlas-commands/` parten de `.atlas/context/knowledge`; también se
...
entorno virtual, Native Broker/Codex OAuth válido y acceso de red a OpenAI. Se instala o
