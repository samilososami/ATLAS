...
> Archivo histórico del pipeline de OpenClaw y sus preámbulos. La conversación directa actual carga [`REALTIME_INSTRUCTIONS.md`](REALTIME_INSTRUCTIONS.md), no los contratos de delegación de este archivo. Se conserva únicamente como evidencia del diseño anterior. Para conexiones y recuperación actuales, consulta [`ATLAS-CONNECTIONS.md`](../context/knowledge/ATLAS-CONNECTIONS.md).
